...
const STORAGE_KEYS = {
  TEAMS: 'crm_teams_lk_v8',
  USERS: 'crm_users_lk_v8',
  CONTACTS: 'crm_contacts_lk_v8',
  ALLOCATIONS: 'crm_allocations_lk_v8',
  CALL_LOGS: 'crm_call_logs_lk_v8',
  CUSTOMERS: 'crm_customers_lk_v8',
  ORDERS: 'crm_orders_lk_v8',
  DELIVERY_HISTORIES: 'crm_delivery_histories_lk_v8',
  ACTIVITY_LOGS: 'crm_activity_logs_lk_v8',
  EXPENSE_CATEGORIES: 'crm_expense_categories_lk_v8',
  EXPENSES: 'crm_expenses_lk_v8',
  EMAIL_NOTIFICATIONS: 'crm_email_notifications_lk_v8',
  CURRENT_USER: 'crm_auth_user_lk_v8',
};
