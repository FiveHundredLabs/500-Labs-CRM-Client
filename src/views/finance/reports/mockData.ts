...
const generateMockFinancialData = () => {
  ...
  // Delivered orders reflecting realized revenue in Prisma: model Order
  const deliveredOrders: DeliveredOrderRecord[] = [
    {
      id: 'ord-2026-001',
      orderNumber: 'ORD-2026-4401',
      totalAmount: 145000,
      status: 'DELIVERED',
      deliveredAt: '2026-09-03',
      createdAt: '2026-09-01',
      customerName: 'Kavinda Gunasekara',
      city: 'Colombo',
      itemCount: 4,
      cogs: 60900,
      grossProfit: 84100,
    },
    {
      ...
      customerName: 'Ruwan Kumara Bandara',
      city: 'Kandy',
      itemCount: 6,
      cogs: 90300,
      grossProfit: 124700,
    ...
    {
      id: 'ord-2026-003',
      orderNumber: 'ORD-2026-4403',
      totalAmount: 180000,
      status: 'DELIVERED',
      deliveredAt: '2026-09-01',
      createdAt: '2026-08-30',
      customerName: 'Tharindu Weerasinghe',
      city: 'Galle',
      itemCount: 5,
      cogs: 75600,
      grossProfit: 104400,
    ...
    {
      id: 'ord-2026-004',
      orderNumber: 'ORD-2026-4404',
      totalAmount: 290000,
      status: 'DELIVERED',
      deliveredAt: '2026-08-30',
      createdAt: '2026-08-28',
      customerName: 'Anuki Dharmaratne',
      city: 'Gampaha',
      itemCount: 8,
      cogs: 121800,
      grossProfit: 168200,
    ...
    {
      id: 'ord-2026-005',
      orderNumber: 'ORD-2026-4405',
      totalAmount: 165000,
      status: 'DELIVERED',
      deliveredAt: '2026-08-28',
      createdAt: '2026-08-26',
      customerName: 'Nuwan Premadasa',
      city: 'Kurunegala',
      itemCount: 5,
      cogs: 69300,
      grossProfit: 95700,
    ...
    {
      id: 'ord-2026-006',
      orderNumber: 'ORD-2026-4406',
      totalAmount: 480000,
      status: 'DELIVERED',
      deliveredAt: '2026-08-25',
      createdAt: '2026-08-22',
      customerName: 'Lanka Supermarkets Network',
      city: 'Colombo',
      itemCount: 14,
      cogs: 201600,
      grossProfit: 278400,
    ...
    {
      id: 'ord-2026-007',
      orderNumber: 'ORD-2026-4407',
      totalAmount: 135000,
      status: 'DELIVERED',
      deliveredAt: '2026-08-22',
      createdAt: '2026-08-20',
      customerName: 'Harsha Rajapaksha',
      city: 'Matara',
      itemCount: 4,
      cogs: 56700,
      grossProfit: 78300,
    ...
    {
      id: 'ord-2026-008',
      orderNumber: 'ORD-2026-4408',
      totalAmount: 220000,
      status: 'DELIVERED',
      deliveredAt: '2026-08-18',
      createdAt: '2026-08-16',
      customerName: 'Sithara Samarasinghe',
      city: 'Negombo',
      itemCount: 6,
      cogs: 92400,
      grossProfit: 127600,
    ...
    {
      id: 'ord-2026-009',
      orderNumber: 'ORD-2026-4409',
      totalAmount: 175000,
      status: 'DELIVERED',
      deliveredAt: '2026-08-15',
      createdAt: '2026-08-12',
      customerName: 'Maheshi Silva',
      city: 'Kalutara',
      itemCount: 5,
      cogs: 73500,
      grossProfit: 101500,
    ...
    {
      id: 'ord-2026-011',
      orderNumber: 'ORD-2026-4301',
      totalAmount: 420000,
      status: 'DELIVERED',
      deliveredAt: '2026-07-28',
      createdAt: '2026-07-25',
      customerName: 'Chandima Herath',
      city: 'Kandy',
      itemCount: 12,
      cogs: 176400,
      grossProfit: 243600,
    ...
    {
      id: 'ord-2026-012',
      orderNumber: 'ORD-2026-4302',
      totalAmount: 520000,
      status: 'DELIVERED',
      deliveredAt: '2026-07-20',
      createdAt: '2026-07-16',
      customerName: 'Singha Pharmacies Co',
      city: 'Colombo',
      itemCount: 15,
      cogs: 218400,
      grossProfit: 301600,
    ...
    {
      id: 'ord-2026-015',
      orderNumber: 'ORD-2026-4202',
      totalAmount: 380000,
      status: 'DELIVERED',
      deliveredAt: '2026-06-15',
      createdAt: '2026-06-11',
      customerName: 'Isuru Madushan',
      city: 'Galle',
      itemCount: 11,
      cogs: 159600,
      grossProfit: 220400,
