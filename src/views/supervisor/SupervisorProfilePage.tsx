...
export const SupervisorProfilePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Supervisor Profile" description="Managerial account settings and activity logs" />
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between pb-3">
            <div>
              ...
              <CardDescription>Supervisor actions log for this month</CardDescription>
            </div>
