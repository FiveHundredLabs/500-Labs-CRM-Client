...
const STORAGE_KEYS = {
  TEAMS: 'crm_teams_lk_v9',
  USERS: 'crm_users_lk_v9',
  CONTACTS: 'crm_contacts_lk_v9',
  ALLOCATIONS: 'crm_allocations_lk_v9',
  CALL_LOGS: 'crm_call_logs_lk_v9',
  CUSTOMERS: 'crm_customers_lk_v9',
  ORDERS: 'crm_orders_lk_v9',
  DELIVERY_HISTORIES: 'crm_delivery_histories_lk_v9',
  ACTIVITY_LOGS: 'crm_activity_logs_lk_v9',
  EXPENSE_CATEGORIES: 'crm_expense_categories_lk_v9',
  EXPENSES: 'crm_expenses_lk_v9',
  EMAIL_NOTIFICATIONS: 'crm_email_notifications_lk_v9',
  CURRENT_USER: 'crm_auth_user_lk_v9',
};
