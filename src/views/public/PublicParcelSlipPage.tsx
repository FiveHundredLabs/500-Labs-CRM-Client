...
const TEST_PARCEL_SLIP: ParcelSlipData = {
  ...
  items: [
    ...
    { productName: 'Kids', quantity: 1, unitPrice: 4400, subtotal: 4400, price: 4400 },
  ],
};
...
const FOUR_TEST_PARCEL_SLIPS: ParcelSlipData[] = [
  TEST_PARCEL_SLIP,
  {
    ...
    codAmount: 4750,
    totalAmount: 4750,
    items: [{ productName: 'Adult', quantity: 1, unitPrice: 4400, subtotal: 4400, price: 4400 }],
  },
  {
    ...TEST_PARCEL_SLIP,
  ...
  },
  {
    ...
    totalAmount: 14250,
    items: [
      { productName: 'Adult', quantity: 2, unitPrice: 4750, subtotal: 9500, price: 9500 },
      { productName: 'Kids', quantity: 1, unitPrice: 4400, subtotal: 4400, price: 4400 },
    ],
  },
];
