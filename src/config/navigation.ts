...
export const ROLE_NAVIGATION: Record<UserRole, NavItem[]> = {
  ...
  SUPERVISOR: [
    { label: 'Dashboard', path: '/supervisor/dashboard', icon: Home, isBottomNav: true },
    ...
    { label: 'Team Performance', path: '/supervisor/team-members', icon: Trophy, isBottomNav: true },
    { label: 'Reports', path: '/supervisor/reports', icon: PieChart, isBottomNav: false },
    { label: 'Team Management', path: '/supervisor/team', icon: Users, isBottomNav: false },
